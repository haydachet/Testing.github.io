...
$_Logger_flag = 1;
@_Logger_browser = ();
@_Logger_bw_name = ('Chrome','Firefox','IE6','IE7','IE8','IE9','IE10','IE11','Safari','Unknown Browser');
@_Logger_bw_type = ('chrome','firefox','msie 6','msie 7','msie 8','msie 9','msie 10','Trident','safari','browser unknown');
